    ...
    return (
        <div className="bg-slate-700">
                <div className="flex flex-row justify-between items-center w-screen px-4 py-2 fixed bg-slate-700 border-b-2 border-slate-400">                 
                    ...
                    <h2 className="text-white font-bold text-center text-xl flex-grow uppercase">{onExercises ? {name: selectedName} : "Nueva Rutina"}</h2>
            ...
            <div className="pt-14">
                {isLoading ? <div className="flex items-center justify-center h-screen"><Loading/></div> :
                    <>
                        <Context.Provider value={{MuscularGroups, selectedMuscularGroups, handleGroupSelected, selectedName, setSelectedName, selectedColor, setSelectedColor, setOnExercises}}>
                                <Outlet/>
                        </Context.Provider>
